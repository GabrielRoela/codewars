...
function isOddHeavy(n){
    let hasNoOdds = true
    n.forEach(e => e % 2 == 0 ? 'we' : hasNoOdds = false)
    ...
    let biggestEven = -Infinity
    
    n.forEach(e => {
      if(e % 2 == 0){
        e > biggestEven ? biggestEven = e : 'we'
      }else{
        e < smallestOdd ? smallestOdd = e : 'w/e'
      }
    })
    
    return (smallestOdd > biggestEven)
  }